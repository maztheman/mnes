...
void memory_w_zero_page_indexed_x() { memory_w_zero_page_indexed(GRegisters().x); }

void memory_w_zero_page_indexed_y() { memory_w_zero_page_indexed(GRegisters().y); }
...
void memory_w_absolute_indexed_x() { memory_w_absolute_indexed(GRegisters().x); }

void memory_w_absolute_indexed_y() { memory_w_absolute_indexed(GRegisters().y); }
