...
static inline void cpu_asl() { internals::cpu_asl(GRegisters().byteLatch); }
...
static inline void cpu_lsr() { internals::cpu_lsr(GRegisters().byteLatch); }
...
static inline void cpu_rol() { internals::cpu_rol(GRegisters().byteLatch); }
...
static inline void cpu_ror() { internals::cpu_ror(GRegisters().byteLatch); }
